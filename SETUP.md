...
RECEIPT_ALLOW_LIBRARY_UPLOADS=false
...
- `RECEIPT_ALLOW_LIBRARY_UPLOADS=false` keeps receipt uploads camera-first. Set it to `true` to also let users choose existing receipt images from their photo library/files.
